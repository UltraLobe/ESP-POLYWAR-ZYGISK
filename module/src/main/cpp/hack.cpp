...
void hack_start(const char *_game_data_dir) {
    ...
    SetResolution = (void (*)(int, int, bool)) ((uintptr_t) g_TargetModule.start_address + 0x226336C); //class Screen, method: public static void SetResolution(int width, int height, bool fullscreen, int preferredRefreshRate) { }
    ...
    get_transform = (void *(*) (void *)) ((uintptr_t) g_TargetModule.start_address + 0x22794A8);
    get_position = (Vector3 (*) (void *)) ((uintptr_t) g_TargetModule.start_address + 0x228874C);
    WorldToScreenPoint = (Vector3 (*) (void *, Vector3)) ((uintptr_t) g_TargetModule.start_address + 0x226BD10);
    C_get_main = (void *(*)()) ((uintptr_t) g_TargetModule.start_address + 0x22516AC); 
