...
void (*old_bypass2)(void *instance, int oid);
void bypass2(void *instance, int oid){
}

void (*old_bypass3)(void *instance, int reason);
void bypass3(void *instance, int reason){
}
...
void hack_start(const char *_game_data_dir) {
    ...
    // TODO: hooking/patching here
      ...
      DobbyHook((void *) ((uintptr_t) g_TargetModule.start_address + 0x147E058), (void *) onDestroy,(void**)&old_onDestroy);                            
